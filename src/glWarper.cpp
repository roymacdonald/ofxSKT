...
//--------------------------------------------------------------
bool glWarper::isActive(){
	return active;
}
//--------------------------------------------------------------
void glWarper::activate(){
	ofRegisterMouseEvents(this);
	active=true;
}
//--------------------------------------------------------------
void glWarper::deactivate(){
	ofUnregisterMouseEvents(this);
	active=false;
}
//--------------------------------------------------------------
void glWarper::processMatrices(){
	...
	if (bSetInverse ) {
		...
		cvdst[0].x = 0;
		cvdst[0].y = 0;
		cvdst[1].x = ofGetWidth();
		cvdst[1].y = 0;
		cvdst[2].x = ofGetWidth();
		...
		for(int i = 0; i < 4; i++){
			cvsrc[i].x = corners[i].x  * (float)ofGetWidth();
			cvsrc[i].y = corners[i].y * (float) ofGetHeight();
		}
	}else{
...
//--------------------------------------------------------------
void glWarper::mouseDragged(ofMouseEventArgs &args){
...
//--------------------------------------------------------------
void glWarper::mousePressed(ofMouseEventArgs &args){
...
//--------------------------------------------------------------
void glWarper::mouseReleased(ofMouseEventArgs &args){
	whichCorner = -1;
}
//--------------------------------------------------------------
void glWarper::mouseMoved(ofMouseEventArgs &args){
	whichCorner = -1;
}